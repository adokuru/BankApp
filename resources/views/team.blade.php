...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <ul class="topbar-information">
                        ...
                        <li>
                            <a
                                href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#84e7ebeaf0e5e7f0c4edeae2ebaae7ebe9"><span
                                    class="__cf_email__"
                                    data-cfemail="d4a7baa1b2b294b3b9b5bdb8fab7bbb9">[email&#160;protected]</span></a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6 col-md-6">
                        ...
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <a href="index-2.html" class="nav-link">Money Transfer Demo - 1</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="protecting-your-money.html" class="nav-link">Protecting Your
                                                    Money</a>
                                            </li>
                                            <li class="nav-item">
    ...
    <div class="team-area pt-100 pb-75">
        <div class="container">
            <div class="section-title">
                ...
                <h2>Meet Our Expert And Experienced Team The Real Creators</h2>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-card">
                        <div class="team-image">
                            <img src="assets/images/team/team-1.jpg" alt="Oleev">
                            <ul class="social">
                                <li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-card">
                        <div class="team-image">
                            <img src="assets/images/team/team-2.jpg" alt="Oleev">
                            <ul class="social">
                                <li>
                                    <a href="https://www.facebook.com/EnvyTheme" target="_blank">
                                        <i class="ri-facebook-fill"></i>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-card">
                        <div class="team-image">
                            <img src="assets/images/team/team-3.jpg" alt="Oleev">
                            <ul class="social">
                                <li>
                                    <a href="https://www.facebook.com/EnvyTheme" target="_blank">
                                        <i class="ri-facebook-fill"></i>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-card">
                        <div class="team-image">
                            <img src="assets/images/team/team-4.jpg" alt="Oleev">
                            <ul class="social">
                                <li>
                                    <a href="https://www.facebook.com/EnvyTheme" target="_blank">
                                        <i class="ri-facebook-fill"></i>
    ...
    <div class="team-area bg-F7F7F7 pt-100 pb-100">
        <div class="container">
            <div class="section-title">
                <span>Advisory Board</span>
                <h2>Meet Our Expert And Experienced Advisory Board</h2>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-card">
                        <div class="team-image">
                            <img src="assets/images/team/team-5.jpg" alt="Oleev">
                            <ul class="social">
                                <li>
                                    <a href="https://www.facebook.com/EnvyTheme" target="_blank">
                                        <i class="ri-facebook-fill"></i>
                        ...
                        <div class="team-content">
                            ...
                            <span>CEO · Growth Analytics LLC</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-card">
                        <div class="team-image">
                            <img src="assets/images/team/team-6.jpg" alt="Oleev">
                            <ul class="social">
                                <li>
                                    <a href="https://www.facebook.com/EnvyTheme" target="_blank">
                                        <i class="ri-facebook-fill"></i>
                        ...
                        <div class="team-content">
                            <h3>Sarah Taylor</h3>
                            <span>Head of Innovation · SWIFT</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-card">
                        <div class="team-image">
                            <img src="assets/images/team/team-7.jpg" alt="Oleev">
                            <ul class="social">
                                <li>
                                    <a href="https://www.facebook.com/EnvyTheme" target="_blank">
                                        <i class="ri-facebook-fill"></i>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-team-card">
                        <div class="team-image">
                            <img src="assets/images/team/team-8.jpg" alt="Oleev">
                            <ul class="social">
                                <li>
                                    <a href="https://www.facebook.com/EnvyTheme" target="_blank">
                                        <i class="ri-facebook-fill"></i>
                        ...
                        <div class="team-content">
                            <h3>John Capabel</h3>
                            <span>Business Marketers</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="pagination-area">
                <a href="team.html" class="prev page-numbers"><i class="ri-arrow-left-s-line"></i></a>
                <span class="page-numbers current" aria-current="page">1</span>
                <a href="team.html" class="page-numbers">2</a>
                <a href="team.html" class="page-numbers">3</a>
                <a href="team.html" class="next page-numbers"><i class="ri-arrow-right-s-line"></i></a>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-footer-widget" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500"
                        ...
                        <div class="widget-logo">
                            <a href="index-2.html"><img src="assets/images/logo.png" alt="image"></a>
                        </div>
                    ...
                    <div class="single-footer-widget" data-aos="fade-up" data-aos-delay="80" data-aos-duration="800"
                        ...
                        <ul class="info-links">
                            ...
                            <li><span>Email:</span> <a
                                    href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#32515d5c46535146725b5c545d1c515d5f"><span
                                        class="__cf_email__"
                                        data-cfemail="3d4e53485b5b7d5a505c5451135e5250">[email&#160;protected]</span></a>
                            </li>
