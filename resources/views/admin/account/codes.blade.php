    ...
    <div class="px-4 w-full">
        <div class="flex relative flex-col mb-6 min-w-0 break-words bg-white rounded shadow-lg bg-blueGray-100 xl:mb-0">
            ...
            <div class="flex-auto p-4">
                ...
                <form action="{{ route('admin.account.addcodes') }}" method="POST">
                    @csrf
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <x-input required minlength="4" maxlength="6" type="text" placeholder="{{ __('Account Number') }}" id="name" value="{{ old('name', $account->account_number) }}" required readonly />
                            </div>
                        </div>
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
