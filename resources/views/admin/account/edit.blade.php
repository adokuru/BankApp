                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <input readonly value="{{ $account->user->username }}" required name="username" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="lucky.jesse" spellcheck="false" data-ms-editor="true">
                                <editor-squiggler>
                                    <style>
                                        @media print {
                        ...
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <input readonly value="{{ $account->user->email }}" required name="email" type="email" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="jesse@example.com">
                            </div>
                        </div>
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <input readonly value="{{ $account->user->first_name }}" required name="first_name" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Lucky" spellcheck="false" data-ms-editor="true">
                            </div>
                        </div>
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full lg:w-4/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <input required name="city" type="email" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="New York">
                            </div>
                        </div>
                        <div class="w-full lg:w-4/12 px-4">
                            <div class="relative w-full mb-3">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <input required name="account_type" type="email" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Checking">
                            </div>
                        </div>
                        <div class="w-full lg:w-6/12 px-4">
                            <div class="relative w-full mb-3">
