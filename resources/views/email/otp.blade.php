                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                        ...
                                                                        <img align="center" border="0" src="https://images.unlayer.com/projects/69376/1647350903777-logo.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 32%;max-width: 179.2px;" width="179.2" />
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 31px;font-family:'Cabin',sans-serif;" align="left">
                                                            ...
                                                            <div style="color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 28px; line-height: 39.2px;"><strong><span style="line-height: 39.2px; font-size: 28px;">You initiated a transfer</span></strong>
                                                                    </span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                                            ...
                                                            <div style="line-height: 160%; text-align: left; word-wrap: break-word;">
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">Your transfer is almost complete, please input the below OTP code.</span></p>
                                                                <h3>{{ $mailData['body'] }}</h3>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;" align="left">
                                                            ...
                                                            <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                                ...
                                                                <p style="line-height: 160%; font-size: 14px;"><span style="font-size: 18px; line-height: 28.8px;">Manx Capitale </span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                                            ...
                                                            <div style="color: #fafafa; line-height: 180%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 8px; line-height: 180%;"><span style="font-size: 10px; line-height: 8.8px;">
                                                                        MANX CAPITALE PRIVEE BANQUE will NEVER send you a link to any external website or request your personal banking details via e-mail, telephone or in person. You are advised to always keep your login details safe and never disclose it to anyone.
                                                                        Thank you for choosing MANX CAPITALE PRIVEE BANQUE.</span></p>
